...
#define BOARD_DUEMILANOVE // For breadboard prototyping and experimentation
...
#ifdef BOARD_DUEMILANOVE
  // Puts blue LED in pin 11 so system LED on pin 13 doesn't flash as well.
